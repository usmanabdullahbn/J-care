    ...
    <div className="relative w-full max-w-md mx-auto">
      ...
      >
        ...
        <motion.line
          ...
          stroke="#5B666C" strokeWidth="1"
          initial="hidden" animate="visible" custom={1.7} variants={draw}
        />
        <motion.line x1="115" y1="264" x2="115" y2="276" stroke="#5B666C" strokeWidth="1"
          initial="hidden" animate="visible" custom={1.7} variants={draw} />
        <motion.line x1="250" y1="264" x2="250" y2="276" stroke="#5B666C" strokeWidth="1"
          initial="hidden" animate="visible" custom={1.7} variants={draw} />
