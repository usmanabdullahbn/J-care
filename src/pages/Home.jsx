...
export default function Home() {
  return (
    <PageWrapper>
      {/* HERO */}
      <section className="max-w-6xl mx-auto px-6 lg:px-8 pt-14 pb-20 lg:pt-20 lg:pb-24 grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
        <div>
          <motion.p
        ...
        >
          <img
            ...
            className="w-full h-auto object-contain rounded-2xl lg:rounded-none lg:[mask-image:linear-gradient(to_right,transparent,black_12%)] lg:[-webkit-mask-image:linear-gradient(to_right,transparent,black_12%)]"
          />
        </motion.div>
      </section>
